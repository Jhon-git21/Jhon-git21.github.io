...
<h1 style="font-weight: bold;font-family: 'cambria'" class="mt-4">Hasil Umum</h1>
<hr>
<ol class="breadcrumb mb-4">
	<li style="font-weight: bold;font-family: 'cambria'" class="breadcrumb-item"><a href="?beranda_pelamar">Beranda</a></li>
	<li style="font-weight: bold;font-family: 'cambria'" class="breadcrumb-item active">Hasil Umum</li>
</ol>
