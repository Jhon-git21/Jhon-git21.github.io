...
<head>
	...
	<title>HALAMAN KARYAWAN - SUPPER DAZZLE YOGYAKARTA</title>
...
>
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<a class="navbar-brand" style="font-weight: bold; color: white; font-family: 'cambria'" href="?"><i class="fab fa-java">HALAMAN KARYAWAN</i></a>
		...
		<ul class="navbar-nav ml-auto ml-md-0">
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
					...
					<a style="font-weight: bold; color: black; font-family: 'cambria'" class="dropdown-item" href="<?php echo base_url('logoutkaryawan.php') ?>">LOGOUT</a>
				</div>
			</li>
		</ul>
	</nav>
		...
		<div id="layoutSidenav_content" class="pl-0 ml-0">
			<main>
				<div class="container mt-3">
					...
					<?php  
					if (isset ($_GET['biodata']) && empty($_GET['biodata'])) {
						include 'biodatakaryawan.php';
					}
					elseif (isset($_GET ['hasil_umum']) && empty($_GET['hasil_umum'])) {
					...
					elseif (isset($_GET ['hasil_personal']) && empty($_GET['hasil_personal'])) {
						include 'hasil_personal.php';
					}
					elseif (isset($_GET ['laporan_harian']) && empty($_GET['laporan_harian'])) {
						include 'hariankaryawan.php';
					}
					elseif (isset($_GET ['hasil_personal']) && ($_GET['hasil_personal']=='detail')) {
						include 'detail_hasil_personal.php';
					}
					elseif (isset($_GET ['beranda_pelamar']) && empty($_GET['beranda_pelamar'])) {
						include 'homekaryawan.php';
					}
					elseif (isset($_GET['biodata']) && ($_GET['biodata']=='ubah_karyawan')) {
